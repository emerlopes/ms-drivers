...
public class VehicleController {
    ...
    public VehicleController(IExecuteCreateVehicleUseCase executeCreateVehicleUseCase, IExecuteGetDriverUseCase executeGetDriverUseCase) {
    ...
    public ResponseEntity<?> createVehicle(@RequestBody VehicleDTO vehicleDTO) {
        ...
        final var driver = executeGetDriverUseCase.execute();
